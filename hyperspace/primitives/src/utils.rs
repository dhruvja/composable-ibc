...
pub async fn create_clients(
	...
	let msg = MsgCreateClient {
		client_state: Any::from(client_state_b),
		consensus_state: Any::from(cs_state_b),
	...
	let msg = MsgCreateClient {
		client_state: Any::from(client_state_a),
		consensus_state: Any::from(cs_state_a),
...
pub async fn create_connection(
	...
	let msg = MsgConnectionOpenInit {
		client_id_on_a: chain_b.client_id(),
...
pub async fn create_channel(
	...
	// 	State::Init,
	// 	order,
	// 	channel::Counterparty::new(port_id_on_a.clone(), None),
	...
	let (channel_id_a, channel_id_b) = match events.pop() {
		Some(IbcEvent::OpenConfirmChannel(chan)) =>
			(chan.chan_id_on_a().clone(), chan.chan_id_on_b().clone()),
